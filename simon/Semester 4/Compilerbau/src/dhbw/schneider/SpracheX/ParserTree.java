...
public class ParserTree {
	...
	public ParserTree(TokenType rootType){
		super();
		this.setRoot(rootType.name());
		init();
	}
	...
	public boolean isValid(){
		return !this.root.is("Invalid");
	}
	
	public static ParserTree invalid(){
		return new ParserTree("Invalid");
	}
