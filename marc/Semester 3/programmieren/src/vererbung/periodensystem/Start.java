...
public class Start {
	...
	public static void main(String[] args){
		...
		system.addElement(new Element("Wasserstoff", "H", 1, 'K', Aggregatzustand.GASFOERMIG, true));
		system.addElement(new Element("Helium", "He", 2, 'K', Aggregatzustand.GASFOERMIG, true));
		...
		system.addElement(new Element("Brom", "Br", 35, 'N', Aggregatzustand.FLUESSIG, true));
